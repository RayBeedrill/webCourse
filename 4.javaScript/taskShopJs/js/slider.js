function slider(sliderClass)
{
    ...
    this.setLoop = function(boolVal)
    {
        this.loopSlider = boolVal;
    }
    
    this.setLoopTime = function(timeVal)
    {
        this.loopTimer = timeVal;
    }
    ...
    this.moveRight = function ()
    {
        ...
        if(fstChildPos != '0px')
        {
            ...
            var count = document.querySelectorAll('.slide');
            this.goTo(count.length);
        }
    }
